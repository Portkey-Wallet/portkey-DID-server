...
public class ImRequestProvider : IImRequestProvider, ISingletonDependency
{
    ...
    public ImRequestProvider(IHttpClientFactory httpClientFactory, HostInfoOptions hostInfoOptions, 
        IHttpContextAccessor httpContextAccessor, ImServerOptions imServerOptions)
    {
        _httpClientFactory = httpClientFactory;
        _hostInfoOptions = hostInfoOptions;
        _httpContextAccessor = httpContextAccessor;
        _imServerOptions = imServerOptions;
    }
