...
[DependsOn(
    typeof(CAServerMockServerHttpApiModule),
...
public class MockServerHttpApiHostModule : AbpModule
{
    ...
    private void ConfigureConventionalControllers()
    {
        ...
        {
            options.ConventionalControllers.Create(typeof(CAServerMockServerHttpApiModule).Assembly);
        });
    }
