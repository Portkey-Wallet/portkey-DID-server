...
public class TracingMiddleware
{
    ...
    public async Task Invoke(HttpContext httpContext)
    {
        ...
        httpContext.Response.OnStarting(state =>
        {
            ...
            ctx.Response.Headers.Add(DashTraceIdentifier, new[] { ctx.TraceIdentifier }); 
            // there’s a reason not to use DashExecutionContext.TraceIdentifier value directly here
