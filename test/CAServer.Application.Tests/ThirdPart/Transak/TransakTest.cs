...
public sealed partial class TransakTest : CAServerApplicationTestBase
{
    ...
    [Fact]
    public async Task DecodeJwtTest()
    {
    ...
    {
        TransakEventRawDataDto transakEventRawDataDto = new TransakEventRawDataDto()
        {
            Data = "eyJhbGciOiJIUzI1NiJ9..61L0In4DXAuGhkIKthGObdph47kCSyhtoecOkTAIWcE"
        };
        var res = await _orderProcessorFactory.GetProcessor(MerchantNameType.Transak.ToString()).OrderUpdate(transakEventRawDataDto);
